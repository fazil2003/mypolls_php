...
<center>
		...
		<div class='footer'>&copy MyPolls . </div>
...
if($row>0){
	...
	*/
	...
	$mail->setFrom('alloasktechnologies@gmail.com', 'MyPolls'); // Set the sender of the message.
	$mail->addAddress($email , $username); // Set the recipient of the message.
	$mail->Subject = 'This is your OTP(One Time Password) for MyPolls.'; // The subject of the message.
...
<style>
html{
	background:linear-gradient(to right,#f5576c 0%, #f5576c 100%);
	color:white;
}
#btn{
	border:none;
